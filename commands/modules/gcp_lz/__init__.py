...
class ModuleMetadata(Metadata):
    ...
    def __init__(self, args):
        ...
        # use gcp sdk as follows
        # s3_client = self.boto3_session.client("s3")
        # dynamodb_res = self.boto3_session.resource("dynamodb")


    def bootstrap_landing_zone(self, metadata=None):
        # TODO call your shell script
        # Step 1
        '''
        Delete existing `gcp_infra` items.
        Module automation metadata is stored in your CosmosDB `gcp_infra` table
        delete existing gcp_infra items for your module instance
        '''
